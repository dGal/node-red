...
Node.prototype.send = function(msg) {
    ...
    if (msg === null || typeof msg === "undefined") {
        ...
        if (this._wire) {
            ...
            var destRef = this._wire;
            var destId = (destRef && typeof destRef === 'object') ? destRef.id : destRef;
            var destInput = (destRef && typeof destRef === 'object' && destRef.port != null) ? destRef.port : undefined;
            this._flow.send([{
                msg: msg,
                source: {
                    id: this.id,
