...
module.exports = function(RED) {
    ...
    function FunctionNode(n) {
        ...
        node.tagInputLabel = !!n.tagInputLabel;
        if(node.timeout>0){
            node.timeoutOptions = {
        ...
        node.on("input", function(msg,send,done) {
            // Auto-tag payload with input label if enabled and available
            try {
                if (node.tagInputLabel &&
                    msg &&
                    msg._input &&
                    typeof msg._input.label === 'string' &&
                    msg.payload &&
                    typeof msg.payload === 'object' &&
                    !Buffer.isBuffer(msg.payload)) {
                    msg.payload._inputTag = msg._input.label;
                }
            } catch(err) {
                // ignore tagging errors to maintain backward compatibility
            }
