        ...
        <div id="func-tab-config" style="display:none">
            <div>
                <div class="form-row" style="display: inline-block; margin-right: 50px;">
                    <label for="node-input-inputs"><i class="fa fa-sign-in"></i> <span data-i18n="function.label.inputs">Inputs</span></label>
                    <input id="node-input-inputs" style="width: 60px;" value="1" title="Inputs">
                </div>
                <div class="form-row" style="display: inline-block; margin-right: 50px;">
                ...
                <div class="form-row" style="display: inline-block;">
                    <label for="node-input-tagInputLabel"><i class="fa fa-tag"></i> <span data-i18n="function.label.tagInputLabel">Tag payload with input label</span></label>
                    <input type="checkbox" id="node-input-tagInputLabel" style="vertical-align: middle;">
                </div>
            </div>
...
(function() {
    ...
    RED.nodes.registerType('function',{
        ...
        inputs: function() { var v = parseInt(this.inputs,10); if (isNaN(v)) { v = 1; } return Math.max(0, v); },
        outputs:1,
        icon: "function.svg",
        label: function() {
